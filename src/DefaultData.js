// This is a local datafile: normally this should be a database or something, but that's not the focus of this excercise.

export const defaultText = {
    'title': 'MyReads',
    'searchText': 'Search books on title',
    'searchResultText': 'Now showing $0 of $1 total.',
    'searchTextAdd': 'Search for books by title or author',
    'searchResultAmount': 30,
}
